...
class Booking
{
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="Ladate de départ doit être plus éloignée que la date d'arrivée")
     */
    private $endDate;
    ...
    /**
     * Appelée à chaque fois qu l'on crée une réservation
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates()
    {
        ...
        //2. Il faut comparer les dateschoisies avec les dates impossibles
